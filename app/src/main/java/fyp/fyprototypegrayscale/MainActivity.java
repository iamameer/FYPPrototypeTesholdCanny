...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadpic() {
        ...
        try {
            ...
            //open tres
            String pathTres = Environment.getExternalStorageDirectory()+"/Pictures/CameraAPIDemo/PictureTres.jpg";
            Log.d(DEBUG_TAG,"tr: "+pathTres);
            imgTreshold.setImageDrawable(Drawable.createFromPath(pathTres));

            //open can
            String pathCan = Environment.getExternalStorageDirectory()+"/Pictures/CameraAPIDemo/PictureCan.jpg";
            Log.d(DEBUG_TAG,"can: "+pathCan);
            //imgCanny.setImageDrawable(Drawable.createFromPath(pathCan)); //THIS LINE CAUSES CRASHSHHSHSHSH
